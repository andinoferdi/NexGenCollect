                            ...
                            <div class="scroll-y mh-325px my-5 px-8">
                                ...
                                <div class="d-flex flex-stack py-4">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="mb-0 me-2">
                                            <a href="#"
                                                class="fs-6 text-gray-800 text-hover-primary fw-bolder">Icon Assets</a>
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <a href="../../demo7/dist/pages/projects/project.html"
                                            ...
                                            <div class="d-flex flex-column flex-grow-1">
                                                <!--begin::Title-->
                                                <h5 class="custom-list-title fw-bold text-gray-800 mb-1">Briviba SaaS
                                                </h5>
                                                <!--end::Title-->
                                                <!--begin::Link-->
                                        ...
                                        <a href="../../demo7/dist/pages/projects/project.html"
                                            ...
                                            <div class="d-flex flex-column flex-grow-1">
                                                <!--begin::Title-->
                                                <h5 class="custom-list-title fw-bold text-gray-800 mb-1">Vine Quick
                                                    Reports</h5>
                                                <!--end::Title-->
                                                <!--begin::Link-->
                                        ...
                                        <a href="../../demo7/dist/pages/projects/project.html"
                                            ...
                                            <div class="d-flex flex-column flex-grow-1">
                                                <!--begin::Title-->
                                                <h5 class="custom-list-title fw-bold text-gray-800 mb-1">KC Account
                                                    CRM</h5>
                                                <!--end::Title-->
                                                <!--begin::Link-->
                                        ...
                                        <a href="../../demo7/dist/pages/projects/project.html"
                                            ...
                                            <div class="d-flex flex-column flex-grow-1">
                                                <!--begin::Title-->
                                                <h5 class="custom-list-title fw-bold text-gray-800 mb-1">Baloon SaaS
                                                </h5>
                                                <!--end::Title-->
                                                <!--begin::Link-->
                                        ...
                                        <a href="../../demo7/dist/pages/projects/project.html"
                                            ...
                                            <div class="d-flex flex-column flex-grow-1">
                                                <!--begin::Title-->
                                                <h5 class="custom-list-title fw-bold text-gray-800 mb-1">Most Cloudy
                                                    UMC</h5>
                                                <!--end::Title-->
                                                <!--begin::Link-->
                                        ...
                                        <a href="../../demo7/dist/pages/projects/project.html"
                                            ...
                                            <div class="d-flex flex-column flex-grow-1">
                                                <!--begin::Title-->
                                                <h5 class="custom-list-title fw-bold text-gray-800 mb-1">Disqus Forum
                                                </h5>
                                                <!--end::Title-->
                                                <!--begin::Link-->
                                        ...
                                        <a href="../../demo7/dist/pages/projects/project.html"
                                            ...
                                            <div class="d-flex flex-column flex-grow-1">
                                                <!--begin::Title-->
                                                <h5 class="custom-list-title fw-bold text-gray-800 mb-1">Proove Quick
                                                    CRM</h5>
                                                <!--end::Title-->
                                                <!--begin::Link-->
                            ...
                            <div class="mx-5">
                                ...
                                <div class="text-center pt-10 mb-20">
                                    ...
                                    <a href="#" class="btn btn-primary"
                                        data-bs-target="#kt_modal_upgrade_plan" data-bs-toggle="modal">Upgrade
                                        Plan</a>
                                    <!--end::Action-->
                                </div>
                                <!--end::Container-->
                            ...
                            <div class="mx-5">
                                ...
                                <div class="mb-12">
                                    ...
                                    <div class="d-flex align-items-center bg-light-info rounded p-5 mb-7">
                                        ...
                                        <div class="flex-grow-1 me-2">
                                            <a href="../../demo7/dist/widgets/lists.html"
                                                class="fw-bolder text-gray-800 text-hover-primary fs-6">Air B &amp; B
                                                - Real Estate</a>
                                    ...
                                    <div class="d-flex align-items-center bg-light-danger rounded p-5">
                                        ...
                                        <div class="flex-grow-1 me-2">
                                            <a href="../../demo7/dist/widgets/lists.html"
                                                class="fw-bolder text-gray-800 text-hover-primary fs-6">Nexa - Next
                                                generation</a>
